const projectData = [
  {
    ...
    description:
      " Developed using PHP (Laravel), MySQL, and styled with Bootstrap, this system manages museum visit bookings with features like reservation verification, document attachments, activity scheduling, user role assignment, and booking history tracking, improving both accuracy and efficiency.",
  ...
  },
  {
    ...
    description:
      "Designed e-commerce website interfaces using Figma, and developed the frontend with Vue.js and Nuxt.js, styling the UI with Tailwind CSS. Key features included product display, blog, and links to external ordering channels.",
  ...
  },
  {
    ...
    description:
      "Developed a fun and educational mobile application for children using Kotlin. The app offers interactive games, quizzes, and animations. Parents can also track their child's progress and access parenting resources.",
  ...
  },
  {
    ...
    description:
      "Developed a student attendance management system using React.js, Node.js, MongoDB, and Tailwind CSS with features like user authentication, course & class scheduling, attendance tracking, student registration, lecturer course/session management, and student check-in and attendance record viewing.",
  ...
  },
  {
    ...
    description:
      "Developed a web-based Attendance List and Q&A system using Vue.js and Firebase (Firestore, Authentication) with role-based features for students (attendance, question answering) and teachers (student management, question creation, attendance review, answer review, and question review).",
  ...
  {
    id: 6,
    image: "img/foodyapp/foodyapp.png",
    title: "Foody App",
    description:
      "FoodyApp is a Kotlin-based mobile application developed with Android Studio. It uses ArcGIS SDK to show nearby restaurants on a map based on the user's location. Restaurant data is fetched from Firebase and displayed using FeatureLayer or GraphicsOverlay.",
    tosource: "https://github.com/iicechyd/FoodyApp",
    gallery: ["img/foodyapp/foodyapp.png"],
  },
  {
    id: 7,
    ...
    title: "Money Heist",
    description:
      "Developed a Money Heist-themed game using Phaser 3, where players control a thief collecting coins while avoiding randomly falling bombs. The game ends upon collision with a bomb, and difficulty increases as more coins are collected. This project highlights skills in game mechanics, collision detection, and difficulty scaling.",
  ...
  },
  {
    ...
    title: "The Forest",
    description:
      "2D adventure game built with Phaser 3 and modern JavaScript. Designed tilemap-based levels where players collect points to unlock areas and escape a mysterious forest while avoiding traps and pitfalls.",
  ...
  },
  {
    ...
    description:
      "Developed a web-based VR experience using A-Frame and HTML (ECS architecture) to present 10 interesting facts about the universe. The project included interactive 3D models (planets, stars), background music, narration, images, and animations.",
  ...
  },
  {
    ...
    title: "Doggy Jump",
    description:
      "Developed an infinite jumper game where the player controls a dog character that leaps from one floating platform to another to collect as many bones as possible. The game ends immediately if the character falls. Built using Phaser 3 with modern JavaScript.",
    linkto: "https://iicechyd.github.io/DoggyJump/",
    tosource: "https://github.com/iicechyd/DoggyJump",
    gallery: ["img/doggyjump/doggyjump.png", "img/doggyjump/doggyjump2.png"],
  },
  // {
  //   id: 11,
